...
namespace Blizzard.WoWClassic.ApiClient
{
    public partial class WoWClassicApiClient
    {
        ...
        public Task<ItemDetails> GetItemDetailsAsync(int itemId) => GetItemDetailsAsync(itemId, defaultRegion, defaultNamespace, defaultLocale);
        ...
        /// <returns>Returns an index of connected realms.</returns>
        public async Task<ItemDetails> GetItemDetailsAsync(int itemId, string region = RegionHelper.Us, string @namespace = NamespaceHelper.Static, string locale = LocaleHelper.EnglishUs)
        {
